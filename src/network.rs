...
impl Network {
    ...
    pub fn backprop(
        ...
        for l in (0..self.layers.len()-1).rev() {
            ...
            layer_deltas.push(next_delta);
        }

        layer_deltas.reverse();
        (all_weighted_sums, all_layers_outputs)
    }
}
